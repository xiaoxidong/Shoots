...
//
    ...
    open class Device {
        ...
        fileprivate static func getVersion(code: String) -> Version {
            switch code {
            /*** iPhone ***/
        ...
        fileprivate static func getType(code _: String) -> Type {
        ...
        public static func hasHomeIndicator() -> Bool {
            let indicators: [Version] = [.iPhoneX, .iPhoneXS, .iPhoneXR, .iPhoneXS_Max, .iPhone11, .iPhone11Pro, .iPhone12, .iPhone12Pro, .iPhone12Pro_Max, .simulator]
            return indicators.contains(version())
        }
    }
#endif
