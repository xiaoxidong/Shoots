...
public enum WeekDay: Int {
    ...
    public func add(days: Int) -> WeekDay {
        ...
        return WeekDay(rawValue: ((rawValue + normalized + 7 - 1) % 7) + 1)!
    }
...
public enum Month: Int, CustomStringConvertible, Equatable {
    ...
    public func name(style: SymbolFormatStyle = .default, locale: LocaleConvertible = SwiftDate.defaultRegion.locale) -> String {
        ...
        let formatter = DateFormatter.sharedFormatter(forRegion: region, format: nil)
        switch style {
        case .default: return formatter.monthSymbols[rawValue]
        case .defaultStandalone: return formatter.standaloneMonthSymbols[rawValue]
        case .short: return formatter.shortMonthSymbols[rawValue]
        case .standaloneShort: return formatter.shortStandaloneMonthSymbols[rawValue]
        case .veryShort: return formatter.veryShortMonthSymbols[rawValue]
        case .standaloneVeryShort: return formatter.veryShortStandaloneMonthSymbols[rawValue]
        }
    }
    ...
    public func add(months: Int) -> Month {
        ...
        return Month(rawValue: (rawValue + normalized + 12) % 12)!
    }
