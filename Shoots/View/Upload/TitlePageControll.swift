...
struct TitlePageControll: UIViewRepresentable {
    ...
    func makeUIView(context _: Context) -> CHIPageControl.CHIPageControlJalapeno {
    ...
    func updateUIView(_ uiView: CHIPageControl.CHIPageControlJalapeno, context _: Context) {
